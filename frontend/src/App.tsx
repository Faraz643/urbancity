...
function App(){
 ...
 const [adFile,setAdFile]=useState<File|null>(null),[adTitle,setAdTitle]=useState(''),[adUrl,setAdUrl]=useState(''),[uploadBusy,setUploadBusy]=useState(false);
