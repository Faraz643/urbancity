...
function App(){
 ...
 const bookingPrice=(b:Billboard,m:number)=>{if(!isMain(b))return m/30*100;if(m===1440)return 2000;if(m>1440)return 2000+((m-1440)/30)*45;return (m/30)*52;};
