...
const MAP_BILLBOARDS: Billboard[] = [
  ...
  { id:'W01', type:'Building Wall', kind:'wall-ad', position:[-20,7.8,-34.62], traffic:'High', bid:3200, occupied:false, ad:'ADVERTISE HERE', size:[5.8,3.4] },
  { id:'W02', type:'Building Wall', kind:'wall-ad', position:[20,8.8,-24.62], traffic:'High', bid:4500, occupied:false, ad:'CITY REACH', size:[7.2,4.2] },
...
function App(){
 ...
 const pricingCategory=(b:Billboard)=>b.type==='Premium Road'||b.type==='Vertical'?'MAIN':b.type==='Building Wall'?'WALL':'CORNER';
 const bookingPrice=(b:Billboard,m:number)=>{const per30=pricingCategory(b)==='MAIN'?49:pricingCategory(b)==='WALL'?29:19;return (m/30)*per30;};
